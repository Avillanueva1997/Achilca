...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SP01-1.SP01-1-1", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("sp01-1-1").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this;
      thes.cargarCumpFechaAt();
    },
    cargarCumpFechaAt: function(){
      var thes = this;
      $.ajax({
        url:   'model/SP01/ListarCumpFechaAt.php', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) {
          ...
          thes.byId("TableSP01-1-1").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/cump_fecha_at.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSP01-1-1").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSP01-1-1").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSP01-1-1").getModel().getData(),
      selectData = thes.byId("TableSP01-1-1").getSelectedContextPaths();
      ...
      thes.byId("TableSP01-1-1").getModel().setData(newTable);
      thes.byId('TableSP01-1-1').removeSelections();
      thes.byId("TableSP01-1-1").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSP01-1-1").getModel().getData();
      ...
      var data = {};
      data._Tabla = "cump_fecha_atencion";
