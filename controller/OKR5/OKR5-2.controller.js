...
sap.ui.define([
 ...
 "sap/ui/model/Filter"
   ...
   return BaseController.extend("sap.ui.app01.controller.OKR5.OKR5-2", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("okr5-2").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarYear: function(){
      ...
      year = (pieces.length == 7 ) ? pieces[pieces.length - 1] : dateToday.getFullYear();
    ...
    onPlanAccion: function(){
      ...
      this._arrangeDialogFragment("Agregar Objetivo: Costo MANTTO", "dialogPA", diametro);
    },
