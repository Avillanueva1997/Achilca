...
sap.ui.define([
 ...
 'sap/base/Log'
   ...
   return BaseController.extend("sap.ui.app01.controller.OKR1.OKR1-2", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("okr1-2").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this,
      date = new Date(),
      year = date.getFullYear();
      thes.cargarDatosMTD(year);
      thes.getMonth();
      thes.getYear();
    },
    ...
    cargarDatosMTD: function(year){
      ...
      $.ajax({
        data: parametros,
        url:   'model/SIMA/ListarSimaMtd.php', 
        type:  'POST',
        async: false,
        beforeSend: function () {
        },
        success:  function (response) {
          ...
          thes.byId("TableSIMA02").setModel(oModel);
        },
    ...
    onChangeNumeroIncidentes: function(oEvent){
      ...
      oData = thes.byId('TableSIMA02').getModel().getData(),
      ...
      oData.promedio = promedio;
    },
    onYearChange: function(oEvent){
      var thes = this,
      oValue = oEvent.getParameter('value'),
      oValue = Number(oValue);
      thes.cargarDatosMTD(oValue);
    }
  });
 });