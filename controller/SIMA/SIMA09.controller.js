...
sap.ui.define([
 ...
 'sap/base/Log'
   ...
   return BaseController.extend("sap.ui.app01.controller.SIMA.SIMA09", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("sima09").attachPatternMatched(this._onObjectMatched, this);      
    },
      ...
      $.ajax({
        ...
        success:  function (response) {
          for (let index = 0; index < response.length; index++) {
            let date =  response[index]['fecha']['date'];
            response[index].fecha = new Date(date.replace(/-/g,"/"));            
          }
