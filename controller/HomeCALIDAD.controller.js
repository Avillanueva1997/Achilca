...
sap.ui.define([
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.HomeCALIDAD", {

       onInit: function(oEvent) {
           var thes = this;
           var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
           oRouter.getRoute("homeCALIDAD").attachPatternMatched(this._onObjectMatched, this);          
       },      
        ...
        $.ajax({
          ...
          success:  function (response) {
            for (let index = 0; index < response.TileCollection.length; index++) {
              if(response.TileCollection[index].view == 'calidad01'){
                response.TileCollection[index].color = statusKpiN1;
              } else if (response.TileCollection[index].view == 'calidad02'){
                response.TileCollection[index].color = statusKpiN2;
              } else if (response.TileCollection[index].view == 'calidad03'){
                response.TileCollection[index].color = statusKpiN3;
              } else if (response.TileCollection[index].view == 'calidad04'){
