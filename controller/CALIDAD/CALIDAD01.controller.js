...
sap.ui.define([
 ...
 "sap/m/Dialog",
  ...
  "sap/m/Label",
  "sap/m/ComboBox"
 ], function (BaseController, JSONModel, VizTooltip, ChartFormatter, Format, CustomerFormat, Dialog, Button, Label, ComboBox ) {
   "use strict";

   return BaseController.extend("sap.ui.app01.controller.CALIDAD.CALIDAD01", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("calidad01").attachPatternMatched(this._onObjectMatched, this);      
    },
