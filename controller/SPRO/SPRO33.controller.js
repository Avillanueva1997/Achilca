...
sap.ui.define([
 ...
 "sap/m/MessageBox"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO33", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro33").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarOP: function(){
      ...
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO33").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      ...
      $.ajax({
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO33").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO33").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO33").getModel().getData(),
      selectData = thes.byId("TableSPRO33").getSelectedContextPaths();
        ...
        sap.m.MessageBox.warning("¿Estás seguro de eliminar esta información?", {
          ...
          onClose: function(oAction) {
            if (oAction === sap.m.MessageBox.Action.YES) {              
              ...
              thes.byId("TableSPRO33").getModel().setData(newTable);
              thes.byId('TableSPRO33').removeSelections();
              thes.byId("TableSPRO33").getModel().refresh();
            }
          }
        });
    ...
    onSave: function(oEvent){
      ...
      var datosTabla = thes.byId("TableSPRO33").getModel().getData();
