...
sap.ui.define([
 ...
 "sap/m/MessageBox"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO05", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro05").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarKpis: function(){
      ...
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO05").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      ...
      $.ajax({
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO05").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO05").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO05").getModel().getData(),
      selectData = thes.byId("TableSPRO05").getSelectedContextPaths();
        ...
        sap.m.MessageBox.warning("¿Estás seguro de eliminar esta información?", {
          ...
          onClose: function(oAction) {
            if (oAction === sap.m.MessageBox.Action.YES) {
              ...
              thes.byId("TableSPRO05").getModel().setData(newTable);
              thes.byId('TableSPRO05').removeSelections();
              thes.byId("TableSPRO05").getModel().refresh();
            }
          }
        });
    ...
    onSave: function(oEvent){
      ...
      var datosTabla = thes.byId("TableSPRO05").getModel().getData();
