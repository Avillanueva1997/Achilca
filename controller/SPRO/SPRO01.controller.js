...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO01", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro01").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this;
      thes.cargarPositions();
    },
    cargarPositions: function(){
      var thes = this;
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO01").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/positions.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO01").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO01").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO01").getModel().getData(),
      selectData = thes.byId("TableSPRO01").getSelectedContextPaths();
      ...
      thes.byId("TableSPRO01").getModel().setData(newTable);
      thes.byId('TableSPRO01').removeSelections();
      thes.byId("TableSPRO01").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSPRO01").getModel().getData();
