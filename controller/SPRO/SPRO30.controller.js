...
sap.ui.define([
 ...
 "sap/m/MessageBox"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO30", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro30").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarResponsable: function(){
      ...
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO30").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/responsable.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO30").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO30").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO30").getModel().getData(),
      selectData = thes.byId("TableSPRO30").getSelectedContextPaths();
        ...
        sap.m.MessageBox.warning("¿Estás seguro de eliminar esta información?", {
          ...
          onClose: function(oAction) {
            if (oAction === sap.m.MessageBox.Action.YES) {
              ...
              thes.byId("TableSPRO30").getModel().setData(newTable);
              thes.byId('TableSPRO30').removeSelections();
              thes.byId("TableSPRO30").getModel().refresh();              
            }
          }
        });
    ...
    onSave: function(oEvent){
      ...
      var datosTabla = thes.byId("TableSPRO30").getModel().getData();
