...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO41", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro41").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarData: function(){
        ...
        $.ajax({
            data: parametros,
            url:   'model/SPRO/ListarDatabaseBolaObs.php', 
            type:  'POST',
            async: false,
            beforeSend: function () {
            },
            success:  function (response) {
                ...
                thes.byId("TableSPRO41").setModel(oModel);
            },
    ...
    onSave: function(oEvent){
      var thes = this,
      datosTabla = thes.byId("TableSPRO41").getModel().getData(),
