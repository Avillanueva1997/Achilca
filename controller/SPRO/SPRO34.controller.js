...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO34", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro34").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarMaquina: function(){
      ...
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO34").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/maquina.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO34").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO34").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO34").getModel().getData(),
      selectData = thes.byId("TableSPRO34").getSelectedContextPaths();
      ...
      thes.byId("TableSPRO34").getModel().setData(newTable);
      thes.byId('TableSPRO34').removeSelections();
      thes.byId("TableSPRO34").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSPRO34").getModel().getData();
