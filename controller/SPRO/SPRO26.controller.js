...
sap.ui.define([
 ...
 "sap/m/MessageBox"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO26", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro26").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this;
      thes.cargarYear();
      thes.cargarLineaProduccion();
      thes.cargarMetaEficiencia();
    },
...
thes.getRouter().navTo("homeSPRO");
    ...
    cargarMetaEficiencia: function(){
      var thes = this;

      $.ajax({
        url:   'model/SPRO/ListarMetaBolaObservada.php', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO26").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/meta_bola_observada.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO26").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO26").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO26").getModel().getData(),
      selectData = thes.byId("TableSPRO26").getSelectedContextPaths();
        ...
        sap.m.MessageBox.warning("¿Estás seguro de eliminar esta información?", {
          ...
          onClose: function(oAction) {
            if (oAction === sap.m.MessageBox.Action.YES) {
              ...
              thes.byId("TableSPRO26").getModel().setData(newTable);
              thes.byId('TableSPRO26').removeSelections();
              thes.byId("TableSPRO26").getModel().refresh();
            }
          }
        });
    ...
    onSave: function(oEvent){
      ...
      var datosTabla = thes.byId("TableSPRO26").getModel().getData();
