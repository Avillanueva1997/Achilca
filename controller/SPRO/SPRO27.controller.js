...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO27", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro27").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this;
      thes.cargarTerminos();
    },
    cargarTerminos: function(){
      var thes = this;
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO27").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/terminos.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO27").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO27").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO27").getModel().getData(),
      selectData = thes.byId("TableSPRO27").getSelectedContextPaths();
      ...
      thes.byId("TableSPRO27").getModel().setData(newTable);
      thes.byId('TableSPRO27').removeSelections();
      thes.byId("TableSPRO27").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSPRO27").getModel().getData();
