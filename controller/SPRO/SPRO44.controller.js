...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO44", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro44").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarData: function(){
        ...
        $.ajax({
            data: parametros,
            url:   'model/SPRO/ListarDatabaseCostoMANTTO.php', 
            type:  'POST',
            async: false,
            beforeSend: function () {
            },
            success:  function (response) {
                ...
                thes.byId("TableSPRO44").setModel(oModel);
            },
    ...
    onSave: function(oEvent){
      var thes = this,
      datosTabla = thes.byId("TableSPRO44").getModel().getData(),
      ...
      var data = {};
      data._Tabla = "database_costomantto";
