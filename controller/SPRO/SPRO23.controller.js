...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO23", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro23").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarUsuarios: function(){
      var thes = this;
      $.ajax({
        url:   'model/SPRO/ListarPermisos.php', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO23").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/permisos.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO23").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO23").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO23").getModel().getData(),
      selectData = thes.byId("TableSPRO23").getSelectedContextPaths();
      ...
      thes.byId("TableSPRO23").getModel().setData(newTable);
      thes.byId('TableSPRO23').removeSelections();
      thes.byId("TableSPRO23").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSPRO23").getModel().getData();
