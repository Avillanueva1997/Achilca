...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO42", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro42").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarData: function(){
        ...
        $.ajax({
            data: parametros,
            url:   'model/SPRO/ListarDatabaseEficiencia.php', 
            type:  'POST',
            async: false,
            beforeSend: function () {
            },
            success:  function (response) {
                ...
                thes.byId("TableSPRO42").setModel(oModel);
            },
    ...
    onSave: function(oEvent){
      var thes = this,
      datosTabla = thes.byId("TableSPRO42").getModel().getData(),
      ...
      var data = {};
      data._Tabla = "database_eficiencia";
