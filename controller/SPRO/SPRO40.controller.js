 ...
 "sap/m/MessageToast"
   ...
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO40", {
    ...
    cargarData: function(){
        ...
        $.ajax({
            data: parametros,
            url:   'model/SPRO/ListarDatabaseUptime.php', 
            type:  'POST',
            async: false,
            beforeSend: function () {
            },
            success:  function (response) {
                ...
                thes.byId("TableSPRO40").setModel(oModel);
            },
    ...
    onSave: function(oEvent){
      var thes = this,
      datosTabla = thes.byId("TableSPRO40").getModel().getData(),
