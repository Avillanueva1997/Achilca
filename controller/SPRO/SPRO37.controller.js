...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO37", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro37").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this;
      thes.getUser();
      thes.cargarDestinatarios();
    },
    cargarDestinatarios: function(){
      var thes = this;
      $.ajax({
        url:   'model/SPRO/ListarDestinatariosOkrs.php', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO37").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      var thes = this;
      $.ajax({
        url:   'model/ENTIDADES/destinatarios.json', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO37").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO37").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO37").getModel().getData(),
      selectData = thes.byId("TableSPRO37").getSelectedContextPaths();
      ...
      thes.byId("TableSPRO37").getModel().setData(newTable);
      thes.byId('TableSPRO37').removeSelections();
      thes.byId("TableSPRO37").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSPRO37").getModel().getData();
      ...
      var data = {};
      data._Tabla = "destinatarios_okrs";
    ...
    getUser: function(){
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            var oModel = new sap.ui.model.json.JSONModel(response);  
            thes.getView().setModel(oModel,"cbxUser");  
          },
          error: function(xhr, ajaxOptions, thrownError){
            alert(xhr.status);
            alert(thrownError);
