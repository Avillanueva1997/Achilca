 ...
 "sap/m/MessageBox"
   ...
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO18", {
    ...
    onInit: function(oEvent){
      ...
      oRouter.getRoute("spro18").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarYear: function(){
      ...
      $.ajax({
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO18").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      ...
      $.ajax({
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO18").getModel().getData();
    ...
    onSave: function(oEvent){
      ...
      var datosTabla = thes.byId("TableSPRO18").getModel().getData();
