...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO36", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro36").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    cargarDestinatarios: function(){
      var thes = this;
      $.ajax({
        url:   'model/SPRO/ListarDestinatariosRP.php', 
        type:  'GET',
        dataType: 'json',
        async: false,
        beforeSend: function () {
        ...
        success:  function (response) {
          ...
          thes.byId("TableSPRO36").setModel(oModel);
        },
    ...
    onAdd: function(oEvent){
      ...
      $.ajax({
        ...
        success:  function (response) { 
          var data = thes.byId("TableSPRO36").getModel().getData();
          ...
          data.push(response);
          thes.byId("TableSPRO36").getModel().refresh();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          alert(xhr.status);
          alert(thrownError);
    ...
    onDelete:function(oEvent){
      var thes = this,
      index,
      datosTabla = thes.byId("TableSPRO36").getModel().getData(),
      selectData = thes.byId("TableSPRO36").getSelectedContextPaths();
      ...
      thes.byId("TableSPRO36").getModel().setData(newTable);
      thes.byId('TableSPRO36').removeSelections();
      thes.byId("TableSPRO36").getModel().refresh();
    },
    onSave: function(oEvent){
      var thes = this;       

      var datosTabla = thes.byId("TableSPRO36").getModel().getData();
