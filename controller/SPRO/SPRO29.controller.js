...
sap.ui.define([
 ...
 "sap/m/MessageToast"
   ...
   "use strict";
   return BaseController.extend("sap.ui.app01.controller.SPRO.SPRO29", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("spro29").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this;
      thes.cargarCostoMantto();
    },
    _onObjectMatched: function(oEvent) {
      var thes = this,
      date = new Date(),
      year = date.getFullYear();
      thes.cargarCostoMantto(year);
      thes.getMonth();
      thes.getYear();
    },
    ...
    cargarCostoMantto: function(year){
      var thes = this,
      parametros = {
        '_year': year
      };
      ...
      $.ajax({
        data: parametros,
        url:   'model/SPRO/ListarCostoMANTTO.php', 
        type:  'POST',
        async: false,
        beforeSend: function () {
        },
        success:  function (response) {
          ...
          thes.byId("TableSPRO29").setModel(oModel);
        },
    ...
    onSave: function(oEvent){
      var thes = this,
      datosTabla = thes.byId("TableSPRO29").getModel().getData(),
