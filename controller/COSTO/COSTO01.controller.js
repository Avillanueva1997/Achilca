...
sap.ui.define([
 ...
 "sap/m/ComboBox"
   ...
   return BaseController.extend("sap.ui.app01.controller.COSTO.COSTO01", {

    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("costo01").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    generateChart: function(YearFilter){
      ...
      $.ajax({
        data: parametros,
        url: 'model/COSTO/GenerarKpiN1.php',
        type: 'POST',
        async: false,
        beforeSend: function(){
        },
