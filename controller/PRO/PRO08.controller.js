...
sap.ui.define([
    ...
    "sap/m/Button",
    "sap/m/ComboBox"
 ], function (BaseController, MessageToast, MessageBox, Label, VizTooltip, ChartFormatter, Format, Link, Text, JSONModel, Formatter, Filter, Dialog, Button, ComboBox) {
   "use strict";
    return BaseController.extend("sap.ui.app01.controller.PRO.PRO08", {
    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("pro08").attachPatternMatched(this._onObjectMatched, this);      
    },
    _onObjectMatched: function(oEvent) {
      var thes = this,
      user = sessionStorage.user,
      role = sessionStorage.role,
      emailResponsable = thes.getResponsableByArea('3');
      thes.generateChart();
    ...
    generateChart: function(YearFilter){
      ...
      linea_produccion,
      parametros,
      url = 'model/PRO/GenerarKpiN1.php',
      actualDate = new Date(),
      ...
      if(YearFilter && YearFilter != '' && YearFilter != actualYear){
        year = YearFilter;
        month = 12;
        url = 'model/PRO/GenerarKpiN1Second.php'
      } else {
              ...
              plotArea: {
                dataPointStyle: {
                  ...
                  [
                    ...
                    {
                      "dataContext": {"Desempeño": {min: 0, max: 100}},
                      "properties": {
                          "color":"#008f39",
                      },
                      "displayName": 'Bueno'
                ...
                dataLabel: {
                    ...
                    renderer: function(oLabel) {
                      ...
                      if(oLabel.ctx.measureNames == "Real"){
                        ...
                        oLabel.ctx.Real = oLabel.ctx.Real + " TM";
                      }
    ...
    cargarActivities: function(){
      ...
      $.ajax({
          data: parametros,
          url:   'model/PA/ListarPaByLineaProduccion.php', 
          type:  'POST',
          async: false,
          beforeSend: function () {
          },
    ...
    onFilerByMonth: function(){
      ...
      $.ajax({
        data: parametros,
        url:   'model/PA/ListarPaByMonthLP.php', 
        type:  'POST',
        async: false,
        beforeSend: function () {
        },
    ...
    onFilterByDates: function(){
      ...
      $.ajax({
        data: parametros,
        url:   'model/PA/ListarPaByDatesLP.php', 
        type:  'POST',
        async: false,
        beforeSend: function () {
        },
