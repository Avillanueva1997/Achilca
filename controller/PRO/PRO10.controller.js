...
sap.ui.define([
   ...
   "use strict";
    return BaseController.extend("sap.ui.app01.controller.PRO.PRO10", {
    onInit: function(oEvent){
      var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
      oRouter.getRoute("pro10").attachPatternMatched(this._onObjectMatched, this);      
    },
    ...
    generateChart: function(YearFilter){
      ...
      linea_produccion,
      parametros,
      url = 'model/PRO/GenerarKpiN2.php',
      actualDate = new Date(),
      ...
      if(YearFilter && YearFilter != '' && YearFilter != actualYear){
        year = YearFilter;
        month = 12;
        url = 'model/PRO/GenerarKpiN2Second.php'
      } else {
