...
$sql = "select sum(costo_real) as Value from costo_mantto_kpi where year = '".$_MinusOneYear."';";
...
{ 	    
    ...
    $sql = "select meta, costo_real from costo_mantto_kpi where year = '".$_Year."' and month = '".$code."';";
