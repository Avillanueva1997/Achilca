...
$sql = "select t1.email, t2.name, t2.lastname from destinatarios_okrs t1 inner join users t2 on t1.user = t2.code;";
...
$message .= '<p>Se ha generado el siguiente reporte de OKRs.</p>';
...
<h4>Estimados,</h4>
<p>Se adjunta el reporte de OKR ACh al {$dateString}</p>
...
$mail->Subject = 'Reporte de OKRs al '.$dateString;
$mail->Body    = $message;
