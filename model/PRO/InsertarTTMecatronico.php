...
$sql = "insert into tt_mecatronico(start_date, end_date, title, info, turno, mecatronico) values('".$start."', '".$end."', '".$title."', '".$info."', '".$turno."', '".$mecatronico."');";
