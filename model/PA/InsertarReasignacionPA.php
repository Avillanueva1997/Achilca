...
$sql = "select * from {$_Table} where code = '".$_Code."' and code_cab = '".$_CodeCab."';";
...
if($row_count == 1){
    ...
    if($row_count == 1){
        ...
        $sql = "insert into {$_Table} values('".$code."', '".$_CodeCab."', '".$actividad."', '".$fecha_eje."', '".$area_res."', '".$_Responsable."', '1', '', NOW(), '".$_Usuario."');";
        ...
        $sql = "update {$_Table} set status = '3', code_rea = '".$code."' where code = '".$_Code."' and code_cab = '".$_CodeCab."';";
